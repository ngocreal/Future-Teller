    ...
    switch (req.method) {
      ...
      case 'POST': {
        ...
        const exists = await pool.query(
          'SELECT id FROM majors WHERE title = $1',
          [title]
        );
        ...
        await pool.query(
          'INSERT INTO majors (title, image) VALUES ($1, $2)',
          [title, imagePath]
        );
      ...
      case 'PUT': {
        ...
        const dup = await pool.query(
          'SELECT id FROM majors WHERE title = $1 AND id != $2',
          [newTitle, id]
        );
        ...
        const curr = await pool.query(
          'SELECT image FROM majors WHERE id = $1',
          [id]
        );
        ...
        await pool.query(
          'UPDATE majors SET title = $1, image = $2 WHERE id = $3',
      ...
      case 'DELETE': {
        ...
        await pool.query('DELETE FROM majors WHERE id = $1', [deleteId]);
