    ...
    switch (req.method) {
      ...
      case 'POST': {
        ...
        const exists = await pool.query(
          'SELECT id FROM technologies WHERE title = $1',
          [title]
        );
        ...
        await pool.query(
          'INSERT INTO technologies (title, image) VALUES ($1, $2)',
          [title, imagePath]
        );
      ...
      case 'PUT': {
        ...
        const dup = await pool.query(
          'SELECT id FROM technologies WHERE title = $1 AND id != $2',
          [newTitle, id]
        );
        ...
        const curr = await pool.query(
          'SELECT image FROM technologies WHERE id = $1',
          [id]
        );
        ...
        await pool.query(
          'UPDATE technologies SET title = $1, image = $2 WHERE id = $3',
      ...
      case 'DELETE': {
        ...
        await pool.query('DELETE FROM technologies WHERE id = $1', [deleteId]);
